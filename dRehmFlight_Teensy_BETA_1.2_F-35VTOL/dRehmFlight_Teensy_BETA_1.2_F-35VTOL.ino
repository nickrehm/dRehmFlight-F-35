...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  if (channel_6_pwm < 1300) {
    ...
    Kp_roll_rate = 0.13;     //Roll P-gain - rate mode
    Ki_roll_rate = 0.3;     //Roll I-gain - rate mode
    Kd_roll_rate = 0.0004;  //Roll D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
    Kp_pitch_rate = 0.19;    //Pitch P-gain - rate mode
    Ki_pitch_rate = 0.3;    //Pitch I-gain - rate mode
    Kd_pitch_rate = 0.0003; //Pitch D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
  
    Kp_yaw = 0.36;           //Yaw P-gain
